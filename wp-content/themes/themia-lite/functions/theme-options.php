...
//****=============================================================================****//	
	    ...
	    //***Code for fourth column***//						
            array("name" => "Fourth Feature Heading",
                "desc" => "Enter your heading line fouth",
                "id" => "inkthemes_headline4",
                "std" => "",
                "type" => "textarea"),
            array("name" => "Fourth Feature Image",
                "desc" => "Upload image for your feature column fourth",
                "id" => "inkthemes_img4",
                "std" => "",
                "type" => "upload"),
            array("name" => "Fourth Feature Content",
                "desc" => "Paste your feature content here... you can also put embed html code but the html content should not exceed the maximum width size. Any content of maximum width is 272px.",
                "id" => "inkthemes_feature4",
                "std" => "",
                "type" => "textarea"),
            array("name" => "Fourth Feature link",
                "desc" => "Enter your link for feature content column fourth",
                "id" => "inkthemes_link4",
                "std" => "",
                "type" => "text"),
	    //***Code for other settings***//
	    array("name" => "Other Settings",
                "type" => "heading"),
	    array("name" => "Paypal Id",
                "desc" => "Enter ID of the Paypal Account",
                "id" => "inkthemes_paypal",
                "std" => "",
                "type" => "text"),
	    array("name" => "Video Link",
                "desc" => "Enter ID of the Video on Vimeo",
                "id" => "inkthemes_video",
                "std" => "",
                "type" => "text"),
	    array("name" => "PlaceHolder Picture",
                "desc" => "Upload image for video placeholder",
                "id" => "inkthemes_img99",
                "std" => "",
                "type" => "upload"),
	    array("name" => "Masscot Picture",
                "desc" => "Upload image for video placeholder",
                "id" => "inkthemes_img98",
                "std" => "",
                "type" => "upload"),
